...
- [layer-wise-anatomical-attention](https://github.com/devMuniz02/layer-wise-anatomical-attention) - Research code for chest X-ray report generation with layer-wise anatomical attention.
- [Image-Attention-Visualizer](https://github.com/devMuniz02/Image-Attention-Visualizer) - Interactive attention visualization for multimodal image-to-text models.
- [DINOv3-Interactive-Patch-Cosine-Similarity](https://github.com/devMuniz02/DINOv3-Interactive-Patch-Cosine-Similarity) - Patch-level visual similarity analysis with DINOv3.
- [UDEM-CXR-Reporting-Thesis-2025](https://github.com/devMuniz02/UDEM-CXR-Reporting-Thesis-2025) - Thesis work on multimodal chest X-ray report generation.

## Connect

- LinkedIn: [linkedin.com/in/devmuniz](https://www.linkedin.com/in/devmuniz)
- Portfolio: [devmuniz02.github.io](https://devmuniz02.github.io/)
- Hugging Face: [huggingface.co/manu02](https://huggingface.co/manu02)
- GitHub: [github.com/devMuniz02](https://github.com/devMuniz02)
